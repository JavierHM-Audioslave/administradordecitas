...
export default class UI {
    ...
    /************** FUNCIONALIDAD: sirve para decidir si el botón submit que apreta el usuario al llenar el formulario, es para crear una nueva cita o para modificar una ya existente. En caso de una u otra, ejecuta una u otra función *******************/
